...
contract SimpleFitnessTracker {
    ...
    function updateWeight(uint256 _newWeight) public onlyRegistered {
        // `storage` refers to persistent data stored on the blockchain; modifies original state
    ...
    function logWorkout(string memory _activityType, uint256 _duration, uint256 _distance) public onlyRegistered {
        // `memory` is temporary and used for in-function computations; does not persist after execution
        ...
        totalDistance[msg.sender] += _duration;
